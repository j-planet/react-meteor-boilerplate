...
exports.render_dropdown = function (items, clickHandler, displayText, inline, extraClassNames, enabled)
{
    if (typeof extraClassNames == 'undefined') extraClassNames = '';
    ...
    return <div className={(inline ? "btn-group" : "dropdown") + ' ' + extraClassNames}>
        <button className="btn dropdown-toggle" type="button" disabled={!enabled}
